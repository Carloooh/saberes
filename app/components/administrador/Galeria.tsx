...
const Galeria: React.FC = () => {
  ...
  const handleUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!allowedTypes.includes(file.type)) {
      ...
      toast.error('Formato de archivo no permitido. Solo se permiten PNG, JPG, JPEG y MP4.');
      return;
    }
  ...
  return (
    <div className="bg-white shadow sm:rounded-lg p-6">
      <div className="mb-6">
        <h1 className="text-xl font-medium text-gray-900 mb-4">Galería de Archivos</h1>
        ...
        <div className="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-lg font-medium text-gray-800 mb-3">Subir nuevo archivo</h2>
      ...
      <div className="space-y-4">
        {archivos.length === 0 ? (
          ...
          archivos.map((archivo) => (
            <div key={archivo.id_archivo} className="border rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow">
              <div className="p-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{archivo.id_archivo}</p>
                      <p className="text-sm text-gray-500">.{archivo.extension}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8a1 1 0 00-1-1zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                      </svg>
                      Eliminar
                    </button>
                  </div>

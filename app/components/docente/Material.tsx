                          ...
                          >
                            ...
                            <div className="flex space-x-2">
                              <button
                                ...
                                className="bg-white text-blue-500 border border-blue-500 px-2 py-1 rounded text-sm hover:bg-blue-500 hover:text-white transition-colors"
                              >
                                Ver
                              </button>
                              <button
                                ...
                                className="bg-white text-green-500 border border-green-500 px-2 py-1 rounded text-sm hover:bg-green-500 hover:text-white transition-colors"
                              >
                                Descargar
                              </button>
                            </div>

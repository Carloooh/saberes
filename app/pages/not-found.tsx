...
export default function NotFound () {
  return (
    <div className="h-screen overflow-hidden bg-gray-100 flex items-center justify-center" style={{ background: '#edf2f7' }}>
      <style>
        {`
          .emoji-404 {
            position: relative;
      ...
      <div className="flex items-center justify-center h-full w-full">
        <center className="text-center">
          ...
          <div className="tracking-widest mt-4">
            <span className="text-gray-500 text-6xl sm:text-7xl md:text-8xl lg:text-9xl block">
              <span>4 0 4</span>
            </span>
            <span className="text-gray-500 text-xl sm:text-2xl md:text-3xl lg:text-4xl">
              No encontramos lo que estabas buscando!
            </span>
          </div>

          <center className="mt-6">
            <Link href="/" className="text-gray-500 font-mono text-xl sm:text-2xl md:text-3xl bg-gray-200 p-3 rounded-md hover:shadow-md">Volver al Inicio</Link>
          </center>
        </center>
      </div>
    </div>

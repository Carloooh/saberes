          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="flex space-x-2">
              <button
                ...
                disabled={isSaving}
                className="bg-white border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-4 py-2 rounded transition-colors duration-200 flex items-center justify-center"
              >
                {isSaving ? (
                  <>
                    <svg
              ...
              <button
                ...
                className="bg-white border-2 border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-white px-4 py-2 rounded transition-colors duration-200 flex items-center justify-center"
              >
                <svg
                  className="w-4 h-4 mr-1"
                  fill="none"
            ...
            {cursoInfo?.enlace_grupo_wsp ? (
              <>
                ...
                <button
                  ...
                  className="bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-3 py-1 rounded-md text-sm font-medium flex items-center transition-colors duration-200"
                >
                  <svg
                    className="w-4 h-4 mr-1"
                    fill="none"
              ...
              <>
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className="bg-white border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-3 py-1 rounded-md text-sm font-medium flex items-center transition-colors duration-200"
                >
                  <svg
                    className="w-4 h-4 mr-1"
                    fill="none"

...
//         console.log("PortalDocente - parsedSession:", parsedSession); // Depuración

//         // Convertir la cadena `asignaturas` en un array de objetos
...
//               id: index + 1, // Asigna un ID único (puedes ajustar esto según tus necesidades)
//               nombre: nombre.trim(), // Elimina espacios en blanco
//             }));
//         } else {
//           parsedSession.asignaturas = []; // Si no es una cadena, inicializa como array vacío
//         }

...
//                     {
//                       userSession?.asignaturas?.filter(
//                         (asignatura) => asignatura.id === curso.id
//                       ).length
//                     }{" "}
//                     asignatura(s)
//                   </p>
...
//                     <a
//                       href={`/portalDocente/${curso.nombre
//                         .toLowerCase()
//                         .replace(/ /g, "-")}`}
//                     >
//                       <button
...
//                         <a
//                           href={`/portalDocente/${modalCurso.nombre
//                             .toLowerCase()
//                             .replace(/ /g, "-")}/${asignatura.nombre
//                             .toLowerCase()
//                             .replace(/ /g, "-")}`}

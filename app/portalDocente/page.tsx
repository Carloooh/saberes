...
const cursos: Curso[] = [
  {
    id: 1,
    nombre: "1ro Básico",
    asignaturas: [{ id: 1, nombre: "Lenguaje" }]
  },
  {
    id: 2,
    nombre: "2do Básico",
  ...
  },
  {
    id: 3,
    nombre: "3ro Básico",
    asignaturas: [{ id: 4, nombre: "Matemáticas" }]
  },
  {
    id: 4,
    nombre: "4to Básico",
          ...
          {cursos.map((curso) => (
            ...
            >
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">{curso.asignaturas.length} asignatura(s)</p>
                <button
                ...
                <ul className="space-y-2">
                  {modalCurso.asignaturas.map((asignatura) => (
                    <li key={asignatura.id}>
                      <a
                        href={`/portal-docente/asignatura/${modalCurso.id}/${asignatura.id}`}

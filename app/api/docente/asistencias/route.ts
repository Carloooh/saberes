...
//       SELECT a.*
//       FROM Asistencia a
//       JOIN DiasAsistencia d ON a.id_dia = d.id_dia
//       WHERE d.id_curso = ? AND d.fecha = ?
//     `);
//     const asistencias = query.all(cursoId, fecha);

//     return NextResponse.json({ success: true, asistencias });
//   } catch (error) {
//     console.error("Error fetching attendance:", error);
//     return NextResponse.json(
//       { success: false, error: "Error fetching attendance" },
//       { status: 500 }
//     );
//   }
// }
